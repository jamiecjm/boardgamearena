 ...
 * states.inc.php
 *
 * Gomoku game states description
 *
 */
...
/*
    ...
    10 => array(
        "name" => "playerTurn",
        "description" => clienttranslate('${actplayer} must play a card of pass'),
        "descriptionmyturn" => clienttranslate('${you} must play a card of pass'),
        "type" => "activeplayer",
